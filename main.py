...
print("5 best by mutual information")
print(fss.get_best_features(inputs_after_pca, mutual_information_feature_selection, 5))
...
print("5 best by RFE")
print(inputs_after_pca[:, rfe_feature_selection == 1])
...
print(remove_eigenface_feature_selection.shape, remove_eigenface_feature_selection)
print("5 best by remove eigenface")
print(fss.get_best_features(inputs_after_pca, remove_eigenface_feature_selection, 5))
